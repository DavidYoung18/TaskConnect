...
export default function ProviderOnboardingCurtainScreen() {
  ...
  async function handleSave() {
    ...
    try {
      const payload = {
        categoryId: 'curtain-cleaning',
        type: 'curtain-company',
        name: 'Curtain Cleaning Company',
        about: about.trim(),
        ratePerSqm: rateNum,
      };
    ...
    >
      <View style={styles.header}>
        ...
        <View style={styles.headerTextBlock}>
          <Text style={styles.title}>{t('providerOnboarding.curtainCompanySetupTitle')}</Text>
          <Text style={styles.subtitle}>{t('categories.curtainCleaning')}</Text>
        </View>
      </View>
      ...
      >
        ...
        <TextInput
          ...
          placeholder={t('providerOnboarding.curtainCompanyNamePlaceholder')}
        ...
        <TextInput
          ...
          placeholder={t('providerOnboarding.curtainAboutPlaceholder')}
          placeholderTextColor="#999999"
          multiline
          numberOfLines={4}
        ...
        {/* Rate */}
        <Text style={[styles.sectionLabel, styles.sectionLabelSpaced]}>{t('providerOnboarding.curtainRateLabel')}</Text>
        <Text style={styles.hint}>{t('providerOnboarding.curtainRateHint')}</Text>
